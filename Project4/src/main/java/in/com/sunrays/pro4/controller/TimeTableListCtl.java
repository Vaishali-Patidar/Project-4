...
import in.com.sunrays.pro4.bean.TimeTableBean;
import in.com.sunrays.pro4.exception.ApplicationException;
import in.com.sunrays.pro4.model.CourseModel;
import in.com.sunrays.pro4.model.SubjectModel;
import in.com.sunrays.pro4.model.TimeTableModel;
...
//	private static Logger log = Logger.getLogger(TimeTableListCtl.class);
	...
	protected BaseBean populateBean(HttpServletRequest request) {
       ...
       //bean.setId(DataUtility.getLong(request.getParameter("id")));
		...
		System.out.println("populate yahaa bean==========>>>> " + bean.getExamDate());
