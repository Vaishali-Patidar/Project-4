...
import in.com.sunrays.pro4.exception.DatabaseException;
...
public class MarksheetModel {
      ...
      //  log.debug("Model nextPK Started");
        ...
        try {
            ...
            PreparedStatement pstmt = conn
                    .prepareStatement("select max(ID) from ST_MARKSHEET_LOG");
    ...
    public long add(MarksheetBean bean) throws ApplicationException,
       ...
       //  get Student Name
        ...
        try {
            ...
            PreparedStatement pstmt = conn
                    .prepareStatement("INSERT INTO ST_MARKSHEET_LOG VALUES(?,?,?,?,?,?,?,?,?,?,?)");
            pstmt.setInt(1, pk);
    ...
    public void delete(MarksheetBean bean) throws ApplicationException {
     ...
     //   log.debug("Model delete Started");
        ...
        try {
            ...
            conn.setAutoCommit(false); // Begin transaction
            PreparedStatement pstmt = conn
                    .prepareStatement("DELETE FROM ST_MARKSHEET_LOG WHERE ID=?");
    ...
    public MarksheetBean findByRollNo(String rollNo)
       ...
       // log.debug("Model findByRollNo Started");
        ...
        StringBuffer sql = new StringBuffer(
                "SELECT * FROM ST_MARKSHEET_LOG WHERE ROLL_NO=?");
    ...
    //    log.debug("Model findByPK Started");
        ...
        StringBuffer sql = new StringBuffer(
                "SELECT * FROM ST_MARKSHEET_LOG WHERE ID=?");
        MarksheetBean bean = null;
        Connection conn = null;
        try {
            conn = JDBCDataSource.getConnection();
    ...
    public void update(MarksheetBean bean) throws ApplicationException,
     ...
     //   log.debug("Model update Started");
        ...
        try {
            ...
            conn.setAutoCommit(false); // Begin transaction
            PreparedStatement pstmt = conn
                    .prepareStatement("UPDATE ST_MARKSHEET_LOG SET ROLL_NO=?,STUDENT_ID=?,NAME=?,PHYSICS=?,CHEMISTRY=?,MATHS=?,CREATED_BY=?,MODIFIED_BY=?,CREATED_DATETIME=?,MODIFIED_DATETIME=? WHERE ID=?");
    ...
    public List search(MarksheetBean bean, int pageNo, int pageSize)
     ...
     //   log.debug("Model  search Started");
        ...
        StringBuffer sql = new StringBuffer(
                "select * from ST_MARKSHEET_LOG where true");
    ...
    public List list(int pageNo, int pageSize) throws ApplicationException {
      ...
      //  log.debug("Model  list Started");
        ...
        ArrayList list = new ArrayList();
        StringBuffer sql = new StringBuffer("select * from ST_MARKSHEET_LOG");
        // if page size is greater than zero then apply pagination
        if (pageSize > 0) {
            // Calculate start record index
            pageNo = (pageNo - 1) * pageSize;
    ...
    public List getMeritList(int pageNo, int pageSize)
     ...
     //   log.debug("Model  MeritList Started");
        ArrayList list = new ArrayList();
        StringBuffer sql = new StringBuffer(
                "SELECT `ID`,`ROLL_NO`, `NAME`, `PHYSICS`, `CHEMISTRY`, `MATHS` , (PHYSICS + CHEMISTRY + MATHS) as total from `ST_MARKSHEET_LOG` order by total desc");
        // if page size is greater than zero then apply pagination
        if (pageSize > 0) {
            // Calculate start record index
            pageNo = (pageNo - 1) * pageSize;
