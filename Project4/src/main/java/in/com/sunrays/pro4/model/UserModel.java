...
import in.com.sunrays.pro4.util.EmailBuilder;
import in.com.sunrays.pro4.util.EmailMessage;
import in.com.sunrays.pro4.util.EmailUtility;
...
public class UserModel {
	...
	public long add(UserBean bean) throws ApplicationException, DuplicateRecordException {
		...
		/*
		 * RoleModel roleModel = new RoleModel(); RoleBean bean2 = new RoleBean(); bean
		 * = roleModel.findByPK(bean.getId());
		 */
		/*
	...
	public void update(UserBean bean) throws ApplicationException, DuplicateRecordException { // log.debug("Model update
																								// Started");
		Connection conn = null;
	...
	public List list(int pageNo, int pageSize) throws ApplicationException {
		...
		ArrayList list = new ArrayList();
		StringBuffer sql = new StringBuffer("select * from ST_USER"); // if page sizeis greater than zero then apply
																		// pagination
	...
	public boolean lock(String login) throws RecordNotFoundException, ApplicationException { // log.debug("Service lock
																								// Started");
		boolean flag = false;
	...
	public boolean changePassword(Long id, String oldPassword, String newPassword)
		...
		if (beanExist != null && beanExist.getPassword().equals(oldPassword)) {
			...
			try {
				...
				ApplicationException("LoginId is already exist");
			}
			flag = true;
		} else {
...
System.out.println("forgetPassword started");
		...
		System.out.println("forgetPassword end");
		return flag;
	}
