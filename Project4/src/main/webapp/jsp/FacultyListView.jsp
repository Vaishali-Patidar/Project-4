<%@page import="in.com.sunrays.pro4.model.FacultyModel"%>
<%@page import="in.com.sunrays.pro4.bean.FacultyBean"%>
<%@page import="in.com.sunrays.pro4.util.HTMLUtility"%>
<%@page import="java.util.Iterator"%>
<%@page import="java.util.List"%>
<%@page import="in.com.sunrays.pro4.controller.FacultyListCtl"%>
...
<jsp:useBean id="bean" class="in.com.sunrays.pro4.bean.FacultyBean" scope="request"></jsp:useBean>
<jsp:useBean id="colbean" class="in.com.sunrays.pro4.bean.CollegeBean" scope="request"></jsp:useBean>
<jsp:useBean id="corbean" class="in.com.sunrays.pro4.bean.CourseBean" scope="request"></jsp:useBean>
