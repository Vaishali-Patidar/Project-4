<%@page import="in.com.sunrays.pro4.model.RoleModel"%>
<%@page import="in.com.sunrays.pro4.model.UserModel"%>
...
<%@page import="in.com.sunrays.pro4.controller.UserListCtl"%>
...
<body>
<jsp:useBean id="bean" class="in.com.sunrays.pro4.bean.UserBean" scope="request" ></jsp:useBean>
...
// 	              List ulist=(List)request.getAttribute("Login");
