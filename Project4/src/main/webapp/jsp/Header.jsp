<%@page import="in.com.sunrays.pro4.bean.RoleBean"%>
<%@page import="in.com.sunrays.pro4.controller.LoginCtl"%>
<%@page import="in.com.sunrays.pro4.bean.UserBean"%>
...
<table>
 ...
 %></td>
        <td rowspan="2">
            <h1 align="Right">
                <img src="<%=ORSView.APP_CONTEXT%>/image/Logo.jpg" width="318"
                    height="80">
            </h1>
       	 </td>
