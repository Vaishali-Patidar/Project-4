<%@page import="in.com.sunrays.pro4.model.StudentModel"%>
<%@page import="in.com.sunrays.pro4.util.ServletUtility"%>
<%@page import="in.com.sunrays.pro4.util.HTMLUtility"%>
<%@page import="java.util.List"%>
<%@page import="java.util.Iterator"%>
<%@page import="in.com.sunrays.pro4.bean.StudentBean"%>
<%@page import="in.com.sunrays.pro4.controller.StudentListCtl"%>
...
<body>
<jsp:useBean id="cbean" class="in.com.sunrays.pro4.bean.CollegeBean" scope="request" ></jsp:useBean>
<jsp:useBean id="bean" class="in.com.sunrays.pro4.bean.StudentBean" scope="request" ></jsp:useBean>
